...
public class Loup extends Monstre{
    ...
    public Loup(String nom, int pV, int dA, int paAtt, int paPar, int ptPar, Point2D p) {
        super(nom, pV, dA, paAtt, paPar, ptPar, p);
    }

    public Loup(Loup l) {
        super(l.getNom(),l.getPtVie(),l.getDegAtt(),l.getPagePar(),l.getPagePar(),l.getPtPar(),new Point2D(l.getPos()));
    }
    public Loup() {
        super("Loup terrifiant",55,12,20,25,10,new Point2D());
    }
